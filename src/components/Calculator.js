...
import {enterNumber, setOperator, percentage, clear, evaluate, toggleNegative} from "../ducks/calculator";
...
export class Calculator extends Component {
	render() {
		const {percentage, toggleNegative, enterNumber, clear, currentValue, setOperator, evaluate} = this.props
...
export default connect(mapStateToProps, {setOperator, evaluate, clear, enterNumber, percentage, toggleNegative})(Calculator);
